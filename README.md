...
1. **Clone the desired repository:** Choose from Admin, Server, Delivery Agent, or Client platforms.
2. **Install dependencies:** Run `npm install` within the project directory.
3. **Start the development server:** Use `npm start` to launch the platform.
